...
CONFIG_SCHEMA = {
    ...
    'required': [
        ...
        'azimuth_serial_port', 'azimuth_serial_baud', 'azimuth_serial_timeout', 'azimuth_loop_delay',
        'shutter_serial_port', 'shutter_serial_baud', 'shutter_serial_timeout',
        'home_azimuth', 'park_azimuth', 'azimuth_move_timeout', 'shutter_move_timeout',
    ],
    'properties': {
        'daemon': {
            'type': 'string',
...
class Config:
    ...
    def __init__(self, config_filename):
        ...
        self.home_azimuth = config_json['park_azimuth']
        self.park_azimuth = config_json['park_azimuth']
        self.azimuth_loop_delay = int(config_json['azimuth_loop_delay'])
